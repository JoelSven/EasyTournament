    ...
    @FXML
        ...
        public void initTable () {
            try {
                ...
                editableCols();
                //System.out.println(teamController.getAmountTeams());
                loadData();
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        private void loadData () {
         ...
         int amountOfTeams = teamController.getTheTeams();
            System.out.println(amountOfTeams);
            ObservableList<TeamStats> dataTable = FXCollections.observableArrayList();
           // dataTable.add(new TeamStats())
          /*  for (int i = 0; i < amountOfTeams; i++) {
                dataTable.add(new TeamStats(String.valueOf(i), "Team" + i, 0, 0, 0, 0));
